...
public class SQLClientApplication extends JApplet {
	...
	private JTextArea jtasqlCommand = new JTextArea("SELECT * FROM BOOK;");
	...
	JTextField jtfUsername = new JTextField("root");
	JPasswordField jpfPassword = new JPasswordField("root");

	JComboBox jcboURL = new JComboBox(new String[] { "jdbc:mysql://localhost:3306/springbootdb",
			"jdbc:odbc:test.db.source", "jdbc:oracle:thin:@test.db.source:1521:orcl" });

	JComboBox jcboDriver = new JComboBox(new String[] { "com.mysql.jdbc.Driver", "sun.jdbc.odbc.JdbcOdbcDriver",
	...
	public static void main(String[] args) {
		SQLClientApplication applet = new SQLClientApplication();
